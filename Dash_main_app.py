...
# Includes:
#   Page 1: DSR Dynamic Dashboard (full)
#   Page 2: Daypart Dashboard (placeholder - plug your layout)
#   Page 3: Sales Dashboard   (placeholder - plug your layout)
...
def load_sales_data() -> pd.DataFrame:
    ...
    for f in files:
        ...
        # ---- Hybrid Auto Date Parsing (no infer_datetime_format warning) ----
...
# Important: initial content includes layout_dsr() so all DSR IDs exist at startup
content = html.Div(
    id="page-content",
    children=layout_dsr(),
    style={
