...
def get_layout():
    ...
    return html.Div([
        ...
        html.Div([
            ...
            html.Div([
                dcc.Dropdown(id="ic_f_brand", placeholder="Brand"),
                dcc.Dropdown(id="ic_f_region", placeholder="Region"),
                dcc.Dropdown(id="ic_f_state", placeholder="State"),
                dcc.Dropdown(id="ic_f_city", placeholder="City"),
                dcc.Dropdown(id="ic_f_type", placeholder="Type"),
                dcc.Dropdown(id="ic_f_outlet", placeholder="Outlet"),
            ], style={
                "display": "grid",
...
def register_callbacks(app):
    ...
    @app.callback(
        ...
        Output("ic_f_region", "options"),
        Output("ic_f_state", "options"),
        Output("ic_f_city", "options"),
        Output("ic_f_type", "options"),
        Output("ic_f_outlet", "options"),
        Input("init_trigger", "n_intervals"),
        Input("ic_f_brand", "value"),
        Input("ic_f_region", "value"),
        Input("ic_f_state", "value"),
        Input("ic_f_city", "value"),
        Input("ic_f_type", "value"),
        Input("ic_f_outlet", "value"),
    )
