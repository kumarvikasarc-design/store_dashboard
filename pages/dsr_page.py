...
def register_callbacks(app):
    ...
    # --------------------
        ...
        # --------------------
        summary = mis = weekly = pd.DataFrame()
        ...
        if (
            ...
            if tab_value == "tab-summary":
                summary = _summary_init.copy()

            elif tab_value == "tab-mis":
                mis = _mis_init.copy()

            elif tab_value == "tab-weekly-mis":
                weekly = _weekly_init.copy()

        else:
            # Only compute when filters applied
            if tab_value == "tab-summary":
                summary, _, _ = build_summary_and_mis(df)

            elif tab_value == "tab-mis":
                _, mis, _ = build_summary_and_mis(df)

            elif tab_value == "tab-weekly-mis":
                _, _, weekly = build_summary_and_mis(df)
